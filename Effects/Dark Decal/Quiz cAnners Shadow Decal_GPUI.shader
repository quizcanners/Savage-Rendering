Shader "GPUInstancer/Quiz cAnners/Illumination Dacals/Simple" 
{
	Properties
	{
...
#pragma multi_compile_instancing
			...
			//QuaterSphere
				...
				float4 frag(v2fMarchBatchableTransparent i) : COLOR
				{
					...
					#if SHAPE_SPHERE
							dist = length(pow(abs(localOffset), 1 + _Box * 10)) * (1 + pow(_Box*10, 1+ _Box * 5)); 

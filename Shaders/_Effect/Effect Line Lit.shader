Shader "QcRendering/Effect/Blood Trail Streak" {
	Properties{
	...
	Category{
        ...
        ENDCG
			...
			float4 frag(v2f i) : COLOR
			{
				...
				float distToCamera = length(_WorldSpaceCameraPos - i.worldPos.xyz);

				float toCamera = distToCamera - _ProjectionParams.y;

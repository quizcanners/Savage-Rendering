...
//	float distFadeSquare =  distFade * distFade;
	float direct = smoothstep( -ao * distFade, 1.5 - ao * 0.5, saturate(dot(normal, lightDir)));
	direct = lerp(direct, 1, distFade);
	
	float3 col = _qc_PointLight_Color.rgb * direct * distFade;

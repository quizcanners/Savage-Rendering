Shader "QcRendering/Decal/Light"
{
	Properties
	{
	...
	SubShader{
		...
		Blend DstColor Zero // Multiplicative//Blend OneMinusDstColor One // Soft additive//Blend DstColor   OneMinusSrcAlpha   // Soft additive // Multiplicative//Blend SrcAlpha OneMinusSrcAlpha
		ZWrite Off
		ZTest Off
		Cull Front

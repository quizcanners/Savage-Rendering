...
namespace QuizCanners.VolumeBakedRendering
{
    public static partial class TracingPrimitives
    {
        ...
        [NonSerialized] public static int SceneElementsVersion = -1;
        public static void OnArrangementChanged() => SceneElementsVersion++;
        ...
        public class EnvironmentElements : IPEGI, IGotCount
        {
            ...
            public Dictionary<Shape, List<int>> GetSortedForVolume(bool rotated)
            {
                ...
                var arrangementChanged = _sortedInstancesVersion.TryChange(SceneElementsVersion);
